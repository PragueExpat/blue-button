...
var exportMedicationEpicSection = function (version) {
    ...
    var MedicationEpicInfo = component.define("MedicationEpicInfo")
        .fields([
            ...
            ["medicationStatus", "0..*", "h:tr/h:td[8]"]
        ]);
    ...
    medicationEpicSection.cleanupStep(function(){
        var result = {};
        var wrapper = (this.js && this.js.medicationEpic && this.js.medicationEpic.length && this.js.medicationEpic[0]) || {};
        var ids = (wrapper.js && wrapper.js.medicationId) || [];
        var statuses = (wrapper.js && wrapper.js.medicationStatus) || [];
