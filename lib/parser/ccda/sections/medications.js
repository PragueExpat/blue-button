...
var exportMedicationsSection = function (version) {
     ...
     */
    var MedicationDose = component.define("MedicationDose")
        .fields([
            ["value", "1..1", "@value", Processor.asFloat],
            ["unit", "0..1", "@unit"],
            ["low_value", "0..1", "h:low/@value", Processor.asFloat],
            ["low_unit", "0..1", "h:low/@unit"],
            ["high_value", "0..1", "h:high/@value", Processor.asFloat],
            ["high_unit", "0..1", "h:high/@unit"]
        ]);
    ...
    var MedicationAdministration = component.define("MedicationAdministration")
        .fields([
            ...
            ["dose", "0..1", "h:doseQuantity", MedicationDose],
    ...
    if (version == "") {
        var MedicationInformation = component.define("MedicationInformation")
            ...
            .fields([
                ...
                ["medicationReferenceId", "0..1", "h:manufacturedMaterial/h:code/h:originalText/h:reference/@value"],
