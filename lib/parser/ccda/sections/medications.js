...
var cleanMedInterval = require("../cleanup_medinterval");
var Processor = require('../processor');

var MedicationInterval = component.define("MedicationInterval")
    .fields([
        ["xsitype", "0..1", "./@xsi:type"],
        ["phase", "0..1", "./h:phase", shared.timeInterval],
        ...
        //["offset", "0..1", "./h:offset", shared.PhysicalQuantity]
    ]).cleanupStep(cleanMedInterval.augmentMedicationInterval);
