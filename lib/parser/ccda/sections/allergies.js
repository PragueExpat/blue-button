...
allergyReaction.fields([
    ["reaction", "1..1", "h:value", shared.ConceptDescriptor, 'epic'],
    severityField
]);

var allergenDescriptor = shared.ConceptDescriptor.define('allergenDescriptor');
allergenDescriptor.fields([
    ["originalText", "0..1", "h:originalText", shared.TextWithReference]
]);
...
allergyObservation.fields([
    ...
    ["allergen", "0..1", "h:participant/h:participantRole/h:playingEntity/h:code", allergenDescriptor], // Require (optional in spec)
