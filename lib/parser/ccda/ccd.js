...
var exportCCD = function (version) {
    ...
    var participants = require("./participants").participants;
    ...
    var medicationEpicSection = require("./sections/medication_epic").medicationEpicSection(version)[0];
    ...
    return component.define("CCD")
        .fields([
            ...
            ["participants", "0..*", "//h:participant/h:associatedEntity", participants],
            ["documentationOf", "0..1", "//h:documentationOf/h:serviceEvent", providers],
//            ["vitals", "0..1", vitalSignsSection.xpath(), vitalSignsSection],
//            ["results", "0..1", resultsSection.xpath(), resultsSection],
            ["medicationStatus", "0..1", medicationEpicSection.xpath(), medicationEpicSection],
