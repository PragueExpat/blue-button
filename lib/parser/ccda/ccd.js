...
var exportCCD = function (version) {
    ...
    var medicationIdsSection = require("./sections/medication_ids").medicationIdsSection(version)[0];
...
//            ["results", "0..1", resultsSection.xpath(), resultsSection],
            ["medicationIds", "0..1", medicationIdsSection.xpath(), medicationIdsSection],
