...
/*
exports.timeInterval = Component.define('timeInterval')
    .fields([
        ["low", "0..1", "h:low", Processor.asTimestamp],
        ["width", "0..1", "h:width", PhysicalQuantity],
        ["center", "0..1", "h:center", Processor.asTimestamp],
        ["high", "0..1", "h:high", Processor.asTimestamp]
    ]);
*/